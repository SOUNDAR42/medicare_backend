...
import { api } from '../api';
import { Pill, Lock, ArrowRight, Shield } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                <div className="absolute -top-40 -right-40 w-96 h-96 bg-rose-200 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob" />
                <div className="absolute bottom-20 -left-40 w-80 h-80 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob animation-delay-2000" />
            </div>

            <div className="w-full max-w-md relative z-10 animate-slide-up">
                <div className="glass-card p-8">
                    <div className="text-center mb-8">
                        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-rose-500 to-pink-500 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-rose-200">
                            <Pill className="h-10 w-10 text-white" />
                        </div>
                        <h2 className="text-2xl font-extrabold text-gray-900">Pharmacy Login</h2>
                        <p className="text-gray-500 mt-2">Manage stock and orders</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text" name="pharmacy_id" value={credentials.pharmacy_id} onChange={handleChange} className="input-modern pl-12" placeholder="E.g., PH123" required />
                            </div>
                        </div>
                        <div>
